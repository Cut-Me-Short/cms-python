...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://www.cutmeshort.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("cutmeshort")
        ...
        """
        self.retries = retries or urllib3.Retry(
            total=3,
            connect=3,
            read=3,
            backoff_factor=0.3,
        ...
        """Retry configuration
        """
        self.request_timeout = (3.05, 30)
        """Default request timeout as tuple(connect, read) in seconds.
        """
    ...
    def debug(self, value: bool) -> None:
        ...
        if self.__debug:
            warnings.warn(
                "Debug mode may log request/response details. Avoid enabling it in production.",
                UserWarning,
            )
