...
class ApiClient:
    """Generic API client for CutMeShort CMS API.

    This client handles the client-
    server communication, and is invariant across implementations. Specifics of
    the methods and models for each application are defined for the CutMeShort
    CMS API.
    ...
    def __init__(
        ...
        self.user_agent = 'cutmeshort-sdk/1.0.1/python'
    ...
    def call_api(
        ...
        try:
            ...
            timeout = _request_timeout or self.configuration.request_timeout
    ...
    def sanitize_for_serialization(self, obj):
        ...
        If obj is a CutMeShort model, return the properties dict.
        ...
        if obj is None:
            ...
            # attributes `openapi_types`, `attribute_map` (pydantic model)
